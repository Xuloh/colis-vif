...
public class DeliveryMap {
     ...
     *                           can begin its round.
     * @throws IllegalArgumentException when the startDateInSeconds is less than
     *                                  0 seconds.
     */
     ...
     * DeliveryMap}. Only other {@link DeliveryMap} are considered for
     * comparison. The method compares the warehouse {@link Node} id, the start
     * date in seconds and the {@link List} of {@link Delivery}.
     *
     ...
     * index i.
     *
     * @param i the index of the {@link Delivery} in the {@link List} of {@link
     *          Delivery}.
