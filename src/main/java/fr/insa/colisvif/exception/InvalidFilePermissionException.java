...
public class InvalidFilePermissionException extends IOException {
    ...
    /**
     * Creates a new {@link InvalidFilePermissionException} with the no message and no cause
     */
    public InvalidFilePermissionException() {
    }

    /**
     * Creates a new {@link InvalidFilePermissionException} with the given message and no cause.
     * @param message the message to display with the {@link InvalidFilePermissionException}
     */
    ...
    /**
     * Creates a new {@link InvalidFilePermissionException} with the given message and cause.
     * @param message the message to display with the {@link InvalidFilePermissionException}
