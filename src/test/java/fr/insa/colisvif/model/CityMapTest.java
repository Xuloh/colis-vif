...
public class CityMapTest {
  ...
  public void shortestRoundSmallTest1()
    ...
    Step step1 = new Step(new Vertex(0, Vertex.PICK_UP, 1), 0, 0);
    step1.addSection(new Section(250, "Rue 0.1", 0, 1));
    step1.setArrivalDate(8 * 3600 + timeTravel(250));

    Step step2 = new Step(new Vertex(1, Vertex.DROP_OFF, 2), 0, 0);
  ...
  public void shortestRoundSmallTest4()
    ...
    Step step2 = new Step(new Vertex(1, Vertex.DROP_OFF, 1), 0, 0);
    step2.addSection(new Section(250, "Rue 1.3", 1, 3));
    step2.setArrivalDate(step1.getArrivalDate() + step1.getDuration() + timeTravel(250));

    Step step3 = new Step(new Vertex(1, Vertex.PICK_UP, 1), 1, 0);
    step3.addSection(new Section(250, "Rue 3.2", 3, 2));
    step3.setArrivalDate(step2.getArrivalDate() + step2.getDuration() + timeTravel(250));

    Step step4 = new Step(new Vertex(1, Vertex.DROP_OFF, 1), 1, 0);
  ...
  public void shortestRoundSmallTest5()
    ...
    Step step3 = new Step(new Vertex(1, Vertex.PICK_UP, 250), 1, 0);
  ...
  public void shortestRoundSmallTest6()
    ...
    Step step2 = new Step(new Vertex(6, Vertex.PICK_UP, 1), 1, 0);
    ...
    Step step3 = new Step(new Vertex(1, Vertex.DROP_OFF, 1), 1, 0);
    ...
    Step step4 = new Step(new Vertex(1, Vertex.DROP_OFF, 2), 0, 0);
  ...
  public void shortestRoundSmallTest8()
    ...
    Step step4 = new Step(new Vertex(0, Vertex.DROP_OFF, 1), 1, 0);
    step4.addSection(new Section(250, "Rue 1.0", 1, 0));
    step4.setArrivalDate(step3.getArrivalDate() + step3.getDuration() + timeTravel(250));

    Step step5 = new Step(new Vertex(1, Vertex.PICK_UP, 1), 2, 0);
    step5.addSection(new Section(250, "Rue 0.1", 0, 1));
    step5.setArrivalDate(step4.getArrivalDate() + step4.getDuration() + timeTravel(250));

    Step step6 = new Step(new Vertex(1, Vertex.PICK_UP, 1), 3, 0);
    step6.setArrivalDate(step5.getArrivalDate() + step5.getDuration());

    Step step7 = new Step(new Vertex(2, Vertex.DROP_OFF, 1), 2, 0);
    step7.addSection(new Section(500, "Rue 1.2", 1, 2));
    step7.setArrivalDate(step6.getArrivalDate() + step6.getDuration() + timeTravel(500));

    Step step8 = new Step(new Vertex(2, Vertex.DROP_OFF, 1), 3, 0);
    step8.setArrivalDate(step7.getArrivalDate() + step7.getDuration());
  ...
  public void shortestRoundSmallTest10()
    ...
    Step step1 = new Step(new Vertex(2, Vertex.PICK_UP, 1), 0, 0);
